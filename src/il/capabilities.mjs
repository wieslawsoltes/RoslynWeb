...
export const capabilities = Object.freeze({
  ...
  supported: [
    ...
    'catch-finally-and-rethrow', 'exception-filters', 'delegates',
    'multicast-delegate-combine-remove-equality-and-invocation-lists',
    'single-thread-event-accessors-and-selected-interlocked-operations', 'javascript-externals',
    ...
    'reflection-dynamicmethod-ilgenerator-and-delegates', 'linked-property-and-indexer-reflection',
    'reflection-assembly-module-type-builders', 'emitted-fields-constructors-properties-and-interface-overrides',
    'queue-stack-linkedlist-and-sorted-collections',
    ...
    'memory-text-and-binary-streams', 'bounded-in-memory-virtual-filesystem',
  ],
  unsupported: [
    ...
    'complete-reflection-emit-generics-custom-attributes-and-persistence', 'platform-native-and-desktop-ui-assemblies',
  ],
  notes: [
    ...
    'DynamicMethod and supported AssemblyBuilder/ModuleBuilder/TypeBuilder APIs generate JavaScript in the current runtime and share linked state; no native code or PE images are emitted.',
    'File/Directory APIs use an explicit in-memory virtual filesystem; host filesystem access, persistence and OS sharing semantics are not implied.',
    'Thread identity and Interlocked services describe one synchronous runtime; they do not create threads, share storage across workers, or provide cross-worker memory ordering.',
