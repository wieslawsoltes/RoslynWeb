...
export const capabilities = Object.freeze({
  ...
  unsupported: [
    ...
    'complete-reflection-emit-type-and-assembly-builders', 'platform-native-and-desktop-ui-assemblies',
  ],
  notes: [
    ...
    'The DynamicMethod/ILGenerator adapter generates JavaScript in the current runtime and shares linked state; it does not generate native code or implement AssemblyBuilder/TypeBuilder.',
