...
import { NuGetResolver, importNupkg } from './packages/index.js';
import { compileAssembly, analyzeAssembly, generateModule } from './il/index.js';
export { NuGetResolver, importNupkg, compileAssembly, analyzeAssembly, generateModule, RoslynError };
...
export async function createRoslyn(options = {}) {
  ...
  if (inWorker) {
    ...
    try { info = await host.call('$init', [{ baseUrl, config: options.config }], options.startupTimeoutMs ?? 120000); }
